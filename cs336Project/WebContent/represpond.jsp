...
<%
	...
	out.println("<a href='customermessages.jsp'><button>Back</button></a>");
...
%>
	...
	<form action="PostMessage.jsp" method="get">
		<input type="hidden" name="threadID" value="<%= threadID %>">
		<input type="hidden" name=threadTitle value="<%= threadTitle %>">
		<input type="hidden" name="threadEmail" value="<%= threadEmail %>">
