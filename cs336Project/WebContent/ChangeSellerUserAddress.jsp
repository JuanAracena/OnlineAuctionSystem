...
<%@ page import="java.util.ArrayList" %>
	...
	<%
		...
		String newAddr = request.getParameter("newAddress");
		...
		String cmd = String.format("UPDATE %s SET %s = '%s' WHERE %s = '%s'", schemaName2, address, newAddr,email, currentUser);
		String cmd2 = String.format("UPDATE %s SET %s = '%s' WHERE %s = '%s'", schemaName, address, newAddr,email, currentUser);
