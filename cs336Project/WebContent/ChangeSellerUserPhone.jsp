...
<%@ page import="java.util.ArrayList" %>
	...
	<%
		...
		String cmd = String.format("UPDATE %s SET %s = '%s' WHERE %s = '%s'", schemaName2, phone, newPhone,email, currentUser);
		String cmd2 = String.format("UPDATE %s SET %s = '%s' WHERE %s = '%s'", schemaName, phone, newPhone,email, currentUser);
